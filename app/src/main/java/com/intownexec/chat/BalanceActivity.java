...
import com.intownexec.chat.util.IabHelper;
import com.intownexec.chat.util.IabResult;
import com.intownexec.chat.util.Inventory;
import com.intownexec.chat.util.Purchase;
...
public class BalanceActivity extends ActivityBase {
    ...
    private static final String TAG = "intownexec.inappbilling";            // Here you can write anything you like! For example: obama.white.house.billing
    private static final String TOKEN = "intownexec.inappbilling";          // Here you can write anything you like! For example: obama.white.house.billing

    // See documentation!

    static final String ITEM_SKU_1 = "chat.intownexec.ru.iap1";          // Change to: yourdomain.com.iap1
    static final String ITEM_SKU_2 = "chat.intownexec.ru.iap2";          // Change to: yourdomain.com.iap2
    static final String ITEM_SKU_3 = "chat.intownexec.ru.iap3";          // Change to: yourdomain.com.iap3
