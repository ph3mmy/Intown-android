...
public class SettingsFragment extends PreferenceFragment implements Constants {
    ...
    private Preference logoutPreference, itemContactUs, aboutPreference, changePassword, itemBalance, itemServices, itemTerms, itemThanks, itemBlackList, itemNotifications, itemDeactivateAccount, itemPrivacy;
